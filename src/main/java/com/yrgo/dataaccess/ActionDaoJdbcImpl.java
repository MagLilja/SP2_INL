...
public class ActionDaoJdbcImpl implements ActionDao, DaoInterface {
    ...
    public void createTable() {
        try {
            this.template
                    .update("CREATE TABLE ACTION (ACTION_ID integer generated by default as identity (start with 1)" +
                            ", DETAILS VARCHAR(255), COMPLETE BOOLEAN" +
                            ", OWNING_USER VARCHAR(20), REQUIRED_BY DATE)");
    ...
    public List<Action> getIncompleteActions(String userId) {
        return this.template.query(GET_INCOMPLETE_SQL,
                new ActionRowMapper(), userId, false);
    }
...
class ActionRowMapper implements RowMapper<Action> {
    public Action mapRow(ResultSet rs, int arg1) throws SQLException {
        ...
        LocalDate requiredByCal = requiredBy.toLocalDate();
